...
var submit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, message) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Message sent successfully!');
...
if (submitForm) submitForm.addEventListener('submit', function (e) {
  ...
  var message = document.getElementById('message').value; // console.log({name, email, message})
